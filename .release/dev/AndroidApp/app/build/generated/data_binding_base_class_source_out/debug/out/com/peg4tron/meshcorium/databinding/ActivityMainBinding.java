...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout mainRoot,
      @NonNull LinearProgressIndicator progressIndicator, @NonNull WebView webView) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, mainRoot, progressIndicator, webView);
    }
