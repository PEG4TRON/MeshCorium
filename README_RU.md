...
Статус релиза `MeshCorium v0.8.2 -- auto-update-fix`:
...
- `Docker Compose` — вариант эксплуатации остаётся рядом с обычным launcher/systemd сценарием; Docker metadata и runtime-версия выровнены на `0.8.2`
