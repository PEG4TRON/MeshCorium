    ...
    <div v-if="model.open" class="mc-overlay" @click="emit('close')">
      <section class="mc-notifications-sheet" @click.stop>
        ...
        <div class="mc-notifications-list">
          <button
            v-if="model.updateEntry"
            class="mc-notification-item mc-notification-item--update"
            @click="emit('open-entry', model.updateEntry)"
          >
            <div class="mc-list-avatar">{{ model.updateEntry.avatarSymbol }}</div>
            <div class="mc-list-main">
              <div class="mc-list-title-row">
                <p class="mc-list-title">{{ model.updateEntry.title }}</p>
                <span class="mc-notification-pill mc-notification-pill--update">{{ t('notifications.updatePill') }}</span>
              </div>
              <p class="mc-list-preview">{{ model.updateEntry.preview }}</p>
            </div>
          </button>
